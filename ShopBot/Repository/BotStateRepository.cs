...
namespace ShopBot.Repository
{
    public class BotStateRepository
    {
        ...
        {
            context.ConversationData.TryGetValue(ProductsInBasket, out IList<Product> products);
        ...
        {
            if (context.ConversationData.TryGetValue(ProductsInBasket, out IList<Product> products))
            {
